// Code Generated By gen-mysqlcrud For "Struct Type: Admin" - DO NOT EDIT;
...
// an error of nil indicates success
// note: this function will have struct tag ggAttr:"9 = GetBy" for columns acting as its source
func (r *Admin) GetByPassword(Password string, Email string) (notFound bool, err error) {
	// clean up
	r._originalValue = nil
	...
	q.Set("SELECT * FROM Admin WHERE Password=? AND Email=? LIMIT 1;")
	q.Ordinal(Password)
...
// [ Notes ]
// 		this function is based on the database column dbAttr:"GetBy" for suffix naming
func (l *AdminList) GetByPassword(Email string, PasswordToLoad ...string) error {
	// validate
	if l == nil {
		return errors.New("List Object Nil")
	}
...
// [ Notes ]
//		this function is based on the database column dbAttr:"GetBy" for suffix naming
func (l *AdminList) FindByPassword(Email string, PasswordToFind ...string) (foundList *[]Admin, err error) {
	// validate
	if l == nil {
		// if not valid, then return error
		return nil, errors.New("List Object Nil")
