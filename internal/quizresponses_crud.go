// Code Generated By gen-mysqlcrud For "Struct Type: QuizResponses" - DO NOT EDIT;
...
// an error of nil indicates success
// note: this function will have struct tag ggAttr:"9 = GetBy" for columns acting as its source
func (r *QuizResponses) GetByUserID(UserID int64) (notFound bool, err error) {
	// clean up
	r._originalValue = nil
	...
	q.Set("SELECT * FROM QuizResponses WHERE UserID=? LIMIT 1;")
	q.Ordinal(UserID)
...
// [ Notes ]
// 		this function is based on the database column dbAttr:"GetBy" for suffix naming
func (l *QuizResponsesList) GetByUserID(UserIDToLoad ...int64) error {
	// validate
	if l == nil {
		return errors.New("List Object Nil")
	}
...
// [ Notes ]
//		this function is based on the database column dbAttr:"GetBy" for suffix naming
func (l *QuizResponsesList) FindByUserID(UserIDToFind ...int64) (foundList *[]QuizResponses, err error) {
	// validate
	if l == nil {
		// if not valid, then return error
		return nil, errors.New("List Object Nil")
